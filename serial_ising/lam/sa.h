...
extern NucStatePtr state;                    /* global annealing parameter struct */

extern StopStyle   stop_flag;               /* type of stop criterion (see above) */

extern int         time_flag;                         /* flag for timing the code */
extern int         log_flag;                 /* flag for displaying log to stdout */
extern int         nofile_flag;      /* flag for not writing .state or .log files */

extern long        state_write;     /* frequency for writing state files (in tau) */
extern long        print_freq;          /* frequency for printing to log (in tau) */
extern long        captions;      /* option for printing freqency of log captions */
...
extern bool         bench;
extern bool         equil; 
extern bool         quenchit;


extern bool init_point_flag;
