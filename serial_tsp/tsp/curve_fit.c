...
/***********************************************************************
 * fit.c created 6-02 Lorraine Greenwald
 ...
 * line by using log log coordinates.  This is hard coded using mode=5.
 ...
 * TO COMPILE:  gcc -lm fit.c then mv a.out fit
 * TO RUN:  ./fit dsj1000_gen2.4021.45
 ...
 * mv outfile dsj1000_gen2.4021.ab 
 *************************************************************************/

      /*****************************************************************
       * a is the y intercept and b is the slope for the straight line *
       *             y = a +(b * x)                                    *
       *             log(y) = a + [ b *log(x)]  this is natural log    *
       * returns fitted y: y=exp( a+b*log(x) )  e raised to the power  *
       *****************************************************************
...
FILE            *infile,*outptr;  
 int             i, j,m,n1,n2;
int             norm=0;	    /* default do NOT normalize */

int             switch_col = 0; /* input X Y default do NOT switch_col */
int             mode=5;    /* default mode =5 */    
                            /* 1-parabolic */
                              /* 2-exponential */
 ...
 ********************************************/
	if (argc != 2)
	{
	printf ("Usage: fit <input file> <mode 5=loglog hardcoded> \n");
 	exit (1);
	}
...
d4 = m * det3(x2,x3,y2,x3,x4,y3,x4,x5,y4) -
     ...
     a2 = d3/d;
     a3 = d4/d;
     /*     a4 = d5/d;   taken out 1-15-03 because d5 is not set */ 
