...
#define  OPTS       ":b:c:C:e:Ef:hlLNpQrRStTvw:W:y:"
...
"Usage: tsp_sa.mpi [-C <covar_ind>]  [-e <freeze_crit>] [-E]\n"
"                 [-f <param_prec>] [-h] [-l] [-L] [-N] [-p] [-r] [-R]\n"
"                 [-S] [-t] [-T] [-v] [-w <outfile> ] [-W <tune_stat>]\n"
"                 [-y <log_freq> ] <infile> \n";
#else
static const char usage[]    =
"Usage: tsp_sa [-e <freeze_crit>] [-E ] [-f <param_prec>] [-h]\n"
"             [-l] [-p] [-Q] [-N ] [-r] [-R] [-t] [-v] [-w <outfile>]\n"
"             [-y <log_freq>] <infile> \n";
#endif
...
"  -R                  print estimated AR coefficient\n"
#ifndef MPI
